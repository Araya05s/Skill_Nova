...
class CourseCategory {
  ...
  factory CourseCategory.fromMap(Map<String, dynamic> map) {
    return CourseCategory(
      id: map[CourseCategoryFields.id] != null ? map[CourseCategoryFields.id] as int : null,
      title: map[CourseCategoryFields.title] as String,
      skills: List<String>.from(json.decode(map[CourseCategoryFields.skills])),
      lowerDuration: CustomDuration.fromString(map[CourseCategoryFields.lowerDuration] as String),
      upperDuration: CustomDuration.fromString(map[CourseCategoryFields.upperDuration] as String),
